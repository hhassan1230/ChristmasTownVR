...
export const setBackground = (roomName) => {
    ...
    let backgroundType = house.rooms[roomName].background.type.toLowerCase();

    if(backgroundType === 'picture' || backgroundType === 'image' || backgroundType === 'photo'){
    ...
    } else if(backgroundType === 'video'){ //need to implement video comming from server
